...
public class HotelRecyclerAdapter extends RecyclerView.Adapter<HotelRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.hotel_title.setText(hotelModel.getNama());
        holder.cardViewHotel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("nama", hotelModel.getNama());
                bundle.putString("lokasi", hotelModel.getLocation());
                bundle.putString("kontak", hotelModel.getKontak());
                bundle.putString("caption", hotelModel.getCaption());
                bundle.putDouble("lat", hotelModel.getLat());
                bundle.putDouble("lng", hotelModel.getLng());
                bundle.putString("gambar", hotelModel.getImgActivityUrl());
                bundle.putString("web", hotelModel.getWeb());
        ...
        GlideApp.with(mContext)
                .asBitmap()
                .load(hotelModel.getImgActivityUrl())
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(View itemView){
            ...
            hotel_title = itemView.findViewById(R.id.hotel_name_id);
